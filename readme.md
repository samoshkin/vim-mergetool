...
So far, it's similar to what [whiteinge/diffconflicts](https://github.com/whiteinge/diffconflicts) already does. But it's only the beginning...
...
" View history revisions, hide 'MERGED' file altogether
